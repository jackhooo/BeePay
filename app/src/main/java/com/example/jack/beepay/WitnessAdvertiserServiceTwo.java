...
public class WitnessAdvertiserServiceTwo extends Service {
        ...
        if (mBluetoothLeAdvertiser == null) {
            ...
            if (mBluetoothManager != null) {
                ...
                if (mBluetoothAdapter != null) {
                    ...
                    Toast.makeText(WitnessAdvertiserServiceTwo.this, "null", Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(WitnessAdvertiserServiceTwo.this, "null", Toast.LENGTH_LONG).show();
            }
    ...
    private void startAdvertising() {
        ...
        if (mAdvertiseCallback == null) {
            ...
            mAdvertiseCallback = new WitnessAdvertiserServiceTwo.SampleAdvertiseCallback();
